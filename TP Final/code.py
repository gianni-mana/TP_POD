...
############################
'''
Este Trabajo sobre datos, analiza el dataset "Video Game Sales" (GregorySmith, 2018, Kaggle) con el objetivo de responder varias preguntas relacionadas
con las ventas de videojuegos. El análisis incluye la limpieza de datos, cálculos estadísticos y generación de gráficos para una
